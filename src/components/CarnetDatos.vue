        ...
        <section>
          ...
          <div class="grid-2-colums">
            ...
            <article>
              ...
              <span>{{ Númerodedocumento }}</span>
            </article>
          </div>
          <div class="grid-2-colums">
            <article>
              <header>FECHA DE EMISIÒN</header>
              <span>{{ FechadeEmisión }}</span>
            </article>
            <article>
  ...
  data(){
    return{
      ...
      Apellidos:"Mendoza",
       ...
       Sexo:"F",
        Fechanacimiento:"10 ENE 2030",
        Númerodedocumento:"222.222.442",
        FechadeEmisión:"01 ENE 2025",
        FechadeVencimiento:"28 JUN 1971",
    }
